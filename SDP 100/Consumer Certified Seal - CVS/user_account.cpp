...
class User {
 public:
  ...
  void create_account(string username, string name, string email, int age,
                      string skin_type, string skin_tone) {
  ...
  do {
    ...
    if (choice == 1) {
      ...
      for (const auto& u : users) {
        if (u.username == username) usernameExists = true;
      ...
      if (usernameExists)
        ...
        User newUser;
        newUser.create_account(username, name, email, age, skin_type,
                               skin_tone);
